...
static RK_S32 check_options(const Bedrock_VENC_CTX_S *ctx) {
...
static const char *const usages[] = {
    "./Bedrock_encoder [-i SRC_PATH] [-w SRC_WIDTH] [-h SRC_HEIGHT]"
};
...
RK_S32 unit_test_mpi_venc(Bedrock_VENC_CTX_S *ctx) {
    RK_S32                  s32Ret = RK_SUCCESS;
    RK_U32                  u32Ch = 0;
